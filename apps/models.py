...
def register(app):
    ...
    class ResourceType(db.Model):
        ...
        def __repr__(self):
            return '<ResourceType %r>' % self.Type
    ...
    class Resource(db.Model):
        ...
        ResourceType_id = db.Column(db.Integer, db.ForeignKey('resource_type.id'))
        ResourceType = db.relationship('ResourceType',
                backref=db.backref('types', lazy='dynamic'))


        def __init__(self, name, url, ResourceType, pub_date=None):
            self.name = name
            self.url = url
            if pub_date is None:
                pub_date = datetime.utcnow()
        ...
        def __repr__(self):
            return '<Resource %r>' % self.ResourceType
